...
def basic_project(project_name: str, gitignores: list) -> bool:
    ...
    # os.chdir("../../../../..")
    # ^ for testing the git repository initialization/initial commit without running into issues
...
def generate_files_basic(project_name):
    ...
    touch("main.css")
    os.chdir("..")
    generate_readme(project_name, "basic")

def generate_readme(project_name, project_type):
    with open("README.md", 'a') as f:
        f.write("# " + project_name + "\n\n")
        f.write("This is a " + project_type + " web project generated with [LazyStarter](https://github.com/Zenahr/lazystarter).\n\n")
...
def start_repo():
    ...
    if "Initialized" in output:
        os.popen('git add .')
        os.popen('git commit -m "first commit, project generated by LazyStarter"')
